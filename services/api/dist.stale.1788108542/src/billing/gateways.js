...
exports.OpenCheckoutGatewayAdapter = exports.ManualGatewayAdapter = void 0;
class ManualGatewayAdapter {
    key = "manual";
...
exports.ManualGatewayAdapter = ManualGatewayAdapter;
class OpenCheckoutGatewayAdapter {
    key;
    config;
    ...
    async parseWebhook(rawBody) {
        ...
        if (this.key === "razorpay")
            return parseRazorpayWebhook(body);
        if (this.key === "paddle")
            return parsePaddleWebhook(body);
        if (this.key === "paypal")
            return parsePaypalWebhook(body);
        return {
...
exports.OpenCheckoutGatewayAdapter = OpenCheckoutGatewayAdapter;
...
function parsePaddleWebhook(body) {
...
function parsePaypalWebhook(body) {
