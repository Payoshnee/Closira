  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-stone-600">Schedule a saved outfit for an event. Conflict checks are prepared for backend calendar logic.</p>
      </div>
      <Card className="p-6">
        <form action="/dashboard/calendar" className="grid gap-5 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-3 sm:flex-row md:col-span-2">
            <Button type="submit">Plan outfit</Button>
