  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-stone-600">Use Closira Native AI or connect providers such as ChatGPT, Claude, Gemini, Azure OpenAI, Ollama, or a custom OpenAI-compatible endpoint.</p>
      </div>
